...
<svelte:head>
	<title>Monivanne - Tea Tingria</title>
	<meta name="description" content="Raikas esitys monella vanteella." />
</svelte:head>
...
<main>
	...
	<EsitysSection sectionHeader="Bangarang">
		...
		/>
		<Tilavaatimus vaatimus="Tilavaatimus minimi 3x3m, kesto 3:30 min" />
	</EsitysSection>
</main>
